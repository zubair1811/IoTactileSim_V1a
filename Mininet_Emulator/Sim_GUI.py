...
Frame_layout=[
      ...
      [sg.Button('EXP#1'),sg.Button('EXP#2')],
      [sg.Button('EXP#3'),sg.Button('EXP#4')],
      [sg.Button('Display Result'),sg.Button('Exit Mininet')]
]
mainlayput=[
      [sg.Text('Wellcome to Teleopertion Virtaul Testbed', size=(90, 1), justification='center',
               background_color='light blue', text_color='red', font='10')],
...
window = sg.Window(title="Tactile Teleoperation Testbed", layout=mainlayput, size=(400, 250),
                         location=(700, 200),
                         font=('Helvetica', 12))
def send():
    while True:
